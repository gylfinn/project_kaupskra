...
namespace project_kaupskra.Controllers
{
    ...
    public class AveragePriceOfSquareMeterController : ControllerBase
    {
        ...
        private readonly IAveragePriceOfSquareMeterRepository _averagePriceOfSquareMeterRepo;

        public AveragePriceOfSquareMeterController(KaupsamningurDbContext context, IAveragePriceOfSquareMeterRepository averagePriceOfSquareMeterRepo)
        {
            _context = context;
            _averagePriceOfSquareMeterRepo = averagePriceOfSquareMeterRepo;
        }

        //GET: api/averagePriceOfSquareMeter
        [HttpGet("")]
        public async Task<ActionResult<string>> GetAveragePriceOfSquareMeter([FromQuery] QueryObject query)
        {
            var averagePriceOfSquareMeter = await _averagePriceOfSquareMeterRepo.GetAveragePriceOfSquareMeter(query);
